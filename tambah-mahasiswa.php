...
<div class="container mt-5">
    <h1><i class="fas fa-user-graduate"></i> Tambah Data Mahasiswa</h1>
    <hr>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="nama" class="form-label">Nama Mahasiswa</label>
            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Mahasiswa.." autocomplete="off" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="mb-3 col-6">
                ...
                <input type="number" class="form-control" id="telepon" name="telepon" placeholder="No Telepon.." autocomplete="off" required>
            </div>
